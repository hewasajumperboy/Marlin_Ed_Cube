...
#define STRING_CONFIG_H_AUTHOR "(Brandon Brocker, 20240113, config: Brandon's BTT_GTR_V1_0)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Ed Cube 3D Printer"
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #else
    // Probed values: P28.45 I3.23 D62.58
    #define DEFAULT_Kp  28.5
    #define DEFAULT_Ki  3.23
    #define DEFAULT_Kd  62.6
  #endif
#endif
...
*  sensor, set “Z_MIN_PROBE_ENDSTOP_INVERTING” to true. And for a PNP-type
*  sensor, set both “Z_MIN_PROBE_ENDSTOP_INVERTING” and “Z_MIN_ENDSTOP_INVERTING”
*  to false. For example, a moving pin probe like a BLTouch would be set to false.
*
*  Source: https://all3dp.com/2/how-to-set-up-marlin-for-auto-bed-leveling/
*/
