...
#define STRING_CONFIG_H_AUTHOR "(Brandon Brocker, 20250704)" // Original author or contributor.
...
#define CUSTOM_MACHINE_NAME "RubbishReplicator9000"
...
#define PIDTEMPBED
  ...
  // 24V 200x270 HICTOP Bed behind an external mosfet @100C - 
  //#define DEFAULT_bedKp   180.7
  //#define DEFAULT_bedKi   34.22
  //#define DEFAULT_bedKd   636.1
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 99.90 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -21.7, 1.5, -2.81 }
...
#define X_MAX_POS 298-69
#define Y_MAX_POS 290-4
...
#define LCD_BED_TRAMMING
  ...
  // NOTE: this value should follow PROBE_TO_NOZZLE Z offset!!!
  #define BED_TRAMMING_HEIGHT      -2.9       // (mm) Z height of nozzle at tramming points
