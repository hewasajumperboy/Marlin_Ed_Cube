...
#define STRING_CONFIG_H_AUTHOR "Brandon Brocker, 20250411, MPX.3" // Who made the changes.
...
#ifndef MOTHERBOARD
  #define MOTHERBOARD BOARD_HICTOP_MPX3
#endif
...
#define CUSTOM_MACHINE_NAME "Hictop 3DP-08"
...
#define X_MIN_ENDSTOP_INVERTING true 	    // Set to true to invert the logic of the endstop. (True for HICTOP)
#define Y_MIN_ENDSTOP_INVERTING true 	    // Set to true to invert the logic of the endstop. (True for HICTOP)
#define Z_MIN_ENDSTOP_INVERTING false 	    // Set to true to invert the logic of the endstop. (True for SN-04-N False for BLTOUCH)
#define Z_MIN_PROBE_ENDSTOP_INVERTING false // Set to true to invert the logic of the probe.   (True for SN-04-N False for BLTOUCH)
#define I_MIN_ENDSTOP_INVERTING true 	    // Set to true to invert the logic of the endstop. (True for HICTOP)
#define J_MIN_ENDSTOP_INVERTING true 	    // Set to true to invert the logic of the endstop. (True for HICTOP)
#define K_MIN_ENDSTOP_INVERTING true 	    // Set to true to invert the logic of the endstop. (True for HICTOP)
#define U_MIN_ENDSTOP_INVERTING true 	    // Set to true to invert the logic of the endstop. (True for HICTOP)
#define V_MIN_ENDSTOP_INVERTING true 	    // Set to true to invert the logic of the endstop. (True for HICTOP)
#define W_MIN_ENDSTOP_INVERTING true 	    // Set to true to invert the logic of the endstop. (True for HICTOP)
#define X_MAX_ENDSTOP_INVERTING true 	    // Set to true to invert the logic of the endstop. (True for HICTOP)
#define Y_MAX_ENDSTOP_INVERTING true 	    // Set to true to invert the logic of the endstop. (True for HICTOP)
#define Z_MAX_ENDSTOP_INVERTING true 	    // Set to true to invert the logic of the endstop. (True for HICTOP)
#define I_MAX_ENDSTOP_INVERTING true 	    // Set to true to invert the logic of the endstop. (True for HICTOP)
#define J_MAX_ENDSTOP_INVERTING true 	    // Set to true to invert the logic of the endstop. (True for HICTOP)
#define K_MAX_ENDSTOP_INVERTING true 	    // Set to true to invert the logic of the endstop. (True for HICTOP)
#define U_MAX_ENDSTOP_INVERTING true 	    // Set to true to invert the logic of the endstop. (True for HICTOP)
#define V_MAX_ENDSTOP_INVERTING true 	    // Set to true to invert the logic of the endstop. (True for HICTOP)
#define W_MAX_ENDSTOP_INVERTING true 	    // Set to true to invert the logic of the endstop. (True for HICTOP)
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 94.4 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -29, 6, -2 }
