...
#define LIN_ADVANCE
  ...
  #else
    //#define ADVANCE_K 0.17        // (mm) Compression length applying to all extruders
    #define ADVANCE_K 0.055        // BB 20250411 - printed https://ellis3dp.com/Pressure_Linear_Advance_Tool/
  #endif
