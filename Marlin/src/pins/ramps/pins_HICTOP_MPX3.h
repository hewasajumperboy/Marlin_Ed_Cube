...
// Pin 19 is a DIO pin and can be used for filament runout sensor
// Unused, coopt it for our own purposes
#undef SERVO3_PIN                   // Undefine SERVO3
#undef Z_MAX_PIN                    // Undefine Z_MAX_PIN
#define SERVO3_PIN      19
#undef FIL_RUNOUT_PIN               // Undefine FIL_ROUNOUT
#define FIL_RUNOUT_PIN  SERVO3_PIN  // Now the assignment

// Pin 11 is a DIO pin and can be used for BLTouch Deploy
